...
export const projects = {
  ...
  /* Featured on the visual track only, and with no case study written
     yet: `noPage` keeps its stage from linking anywhere and keeps it out
     of prev/next, so no reader is sent to a page that isn't there. */
  bubu: {
    title: "BUBU",
    navName: "BUBU",
...
function card(slug, track) {
  ...
  return { ...project, ...(track === "visual" ? visual : null), slug, href: project.noPage ? null : projectHref(slug, track) }
}

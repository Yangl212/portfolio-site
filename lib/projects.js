...
export const projects = {
  ...
  cleared: {
    ...
    navName: "Google Calendar: AI Scheduling Redesign",
    description:
...
export const trackOrder = {
  uiux: ["uxcasestudy", "cleared", "lastmessage", "backstage", "graveyard", "taroo", "alcohol", "suglar"],
  visual: ["taroo", "suglar", "uxcasestudy", "graveyard", "cleared", "alcohol", "lastmessage", "backstage"]
}

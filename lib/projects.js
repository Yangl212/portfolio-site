...
export const projects = {
  ...
  bubu: {
    title: "BUBU",
    navName: "BUBU",
    description: "An iOS app for an eight-week weight-loss challenge. Meals become daily receipts, and seven days of records become a weekly journal shared with a buddy.",
    tags: ["App Design", "Illustration"],
    category: "App Design",
    year: "2026",
    image: "/covers/bubu.webp",
    zh: {
      description: "一款为八周减脂挑战设计的 iOS App。拍照记下一餐，每天生成一张小票，每周整理成手账。",
      tags: ["App 设计", "插画"],
      category: "App 设计"
    }
  },
...
export const trackOrder = {
  uiux: ["vortexnet", "boa-budgeting", "cleared", "lastmessage", "backstage", "graveyard", "taroo", "alcohol", "suglar"],
  visual: ["lastmessage", "suglar", "bubu", "boa-budgeting", "graveyard", "vortexnet", "cleared", "alcohol", "taroo", "backstage"]
}

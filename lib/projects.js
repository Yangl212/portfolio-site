...
export const projects = {
  ...
  vortexnet: {
    ...
    /* Three screens from the shipped dashboard - unlike cleared's windows,
       the main dashboard shot stays clear of the cover instead of sinking
       behind it, since it is the one worth actually reading. */
    cardStyle: "panels",

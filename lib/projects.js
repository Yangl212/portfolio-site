...
export const projects = {
  ...
  lastmessage: {
    ...
    description:
        "Designing an open-ended detective game through AI conversations, connected evidence, and branching story paths.",
    tags: ["AI", "Web Design"],
  ...
  vortexnet: {
    ...
    description:
      "Information hierarchy and consolidation for an internal finance dashboard. A partially shipped internship project.",
...
export const trackOrder = {
  uiux: ["uxcasestudy", "vortexnet", "lastmessage", "cleared", "backstage", "graveyard", "taroo", "alcohol", "suglar"],
  visual: ["taroo", "suglar", "uxcasestudy", "graveyard", "vortexnet", "cleared", "alcohol", "lastmessage", "backstage"]
}

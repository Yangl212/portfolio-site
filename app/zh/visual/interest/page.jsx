/* Chinese mirror of the English route at /visual/interest - same page, locale="zh".
...
export const metadata = {
  ...pageMetadata,
  alternates: { canonical: "/zh/visual/interest" },
...
export default function ZhVisualInterestPage() {
  return <InterestPage track="visual" locale="zh" />
}

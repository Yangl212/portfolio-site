import BubuPage, { metadata as projectMetadata } from "../../../project/bubu/page"

/* Same case study, entered from the visual track. The page content lives once,
   in app/project/bubu - only the track differs, which is what keeps the
...
export const metadata = {
  ...projectMetadata,
  alternates: { canonical: "/project/bubu" }
}

export default function VisualProjectPage() {
  return <BubuPage track="visual" />
}

import AlcoholProjectPage, { metadata as projectMetadata } from "../../../project/alcohol/page"

/* Same case study, entered from the visual track. The page content lives once,
   in app/project/alcohol - only the track differs, which is what keeps the
...
export const metadata = {
  ...projectMetadata,
  alternates: { canonical: "/project/alcohol" }
}

export default function VisualProjectPage() {
  return <AlcoholProjectPage track="visual" />
}
